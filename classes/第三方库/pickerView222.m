...
@interface pickerView222 ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@property(nonatomic,copy)NSString *resultString22;
@property(nonatomic,copy)NSString *resultID22;
...
-(instancetype)initPickviewWithArray:(NSArray *)array isHaveNavControler:(BOOL)isHaveNavControler{
    ...
    if (self) {
        ...
        _resultString22 = [[_childsArray objectAtSafeIndex:_rowww]objectForKey:@"name"];
        _resultID22 = [NSString stringWithFormat:@"%@",[[_childsArray objectAtSafeIndex:_rowww]objectForKey:@"id"]];
...
-(void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component{
    ...
    if (component == 0) {
        ...
        _resultString22 = [[_childsArray objectAtSafeIndex:0]objectForKey:@"name"];
        _resultID22 = [NSString stringWithFormat:@"%@",[[_childsArray objectAtSafeIndex:0]objectForKey:@"id"]];
        [pickerView selectRow:0 inComponent:1 animated:YES];
    }else if (component == 1){
        _resultString22 = [[_childsArray objectAtSafeIndex:row]objectForKey:@"name"];
        _resultID22 = [NSString stringWithFormat:@"%@",[[_childsArray objectAtSafeIndex:row]objectForKey:@"id"]];
        NSLog(@"_resultString = %@  && _resultID = %@",_resultString22,_resultID22);
...
-(void)doneClick
{
    ...
    if ([self.delegate respondsToSelector:@selector(toobarDonBtnHaveClick:resultID:resultString:)]) {
        [self.delegate toobarDonBtnHaveClick:self resultID22:_resultID22 resultString22:_resultString22];
    }
    [self removeFromSuperview];
}
//设置pickerView的字体大小
