...
- (void)tableReloadData:(NSArray *)titleArray    colorArray:(NSArray *)colorArray{
    //self.frame = rect;
    [_array removeAllObjects];
    [_colorArray removeAllObjects];
     [_colorArray addObjectsFromArray:colorArray];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *colorStr = [_colorArray objectAtIndex:indexPath.row];
    if ([colorStr isEqualToString:@"1"]) {   
         cell.textLabel.textColor = [UIColor redColor];
    }else if([colorStr isEqualToString:@"2"]){
        cell.textLabel.textColor = [UIColor colorWithRed:0.3961 green:0.7294 blue:0.8941 alpha:1];
    }else{
        cell.textLabel.textColor = [UIColor colorWithWhite:0.3 alpha:1];
    }
    //cell.textLabel.highlightedTextColor = [UIColor colorWithRed:0.3961 green:0.7294 blue:0.8941 alpha:1];
    return cell;
}
