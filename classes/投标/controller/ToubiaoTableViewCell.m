...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier  title:(NSString *)title hangye:(NSString *)hangye location:(NSString *)location time:(NSString *)time detail:(NSString *)detail{
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    if (self) {
       [self title:title hangye:hangye location:location time:time detail:detail];
    }
    return self;
}
...
- (void)title:(NSString *)title hangye:(NSString *)hangye location:(NSString *)location time:(NSString *)time detail:(NSString *)detail{
    ...
    _title = [[LableXLJ alloc]initWithFrame:CGRectMake(10, 10, self.bounds.size.width - 20, 45) text:title textColor:[UIColor colorWithWhite:0 alpha:1] font:14 numberOfLines:2 lineSpace:3];
   ...
   [self.contentView addSubview:_title];
    ...
    _detail = [[LableXLJ alloc]initWithFrame:CGRectMake(10, _location.frame.origin.y + _location.bounds.size.height + 12, self.bounds.size.width - 20, 55) text:[NSString stringWithFormat:@"%@",detail] textColor:[UIColor colorWithWhite:0.2 alpha:1] font:11 numberOfLines:3 lineSpace:0];
    [self.contentView addSubview:_detail];
