...
typedef void(^DingyueChooseBlock)(NSDictionary *,NSArray *,NSString *,NSInteger);
@interface DingyueChooseView : UIView
...
@property (nonatomic ,strong)DingyueChooseBlock  block;
