...
//    }
    _title = [[LableXLJ alloc]initWithFrame:CGRectMake(10, 10, self.bounds.size.width - 20, 45) text:title textColor:[UIColor colorWithWhite:0 alpha:1] font:15 numberOfLines:2 lineSpace:3];
